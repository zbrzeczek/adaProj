...
procedure Main is
   ...
   task body Buffer is
      ...
      Storage: Storage_type
        := (0, 0, 0, 0, 0);
    --jesli dobrze rozumiem to tu jest ile kazdy z rodzaji dan/cos(assebly)*3* ma kazdy z produktow
    ...
    --tu chyba ustawia tego max na to co aktualnie ebdize robione--
    ...
    --sprawdza czy buffor ma wystarczajaco meijsca na rzecz od producenta(max 30)--
    ...
    --tu po prostu sprawdza czy w storage mamy wystarczajaco prod na to danie--
